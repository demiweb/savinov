    ...
    if ((document.documentElement.clientWidth) >= 780) {
        ...
        var startime = function () {
            ...
            $(".menu-dot").on("click", function () {
                ...
                $(".global-menu__wrap ul li").addClass("is-opened");

                $(".global-menu__wrap ul li").each(function ()  {
                    this.style.setProperty('--tran', 'translate(105%,0)');
                    this.style.setProperty('--tran1', 'translate(-110%,0)');
                    this.style.setProperty('--op1', '1');
            ...
            $(".closemenumob").on("click", function () {
                ...
                $(".global-menu__wrap ul li").removeClass("is-opened");
                $(".global-menu__wrap ul li").each(function ()  {
                    this.style.setProperty('--tran', 'translate(105%,0)');
                    this.style.setProperty('--tran1', 'translate(-110%,0)');
                    this.style.setProperty('--op1', '1');
...
//HOVER FUNCTION HOVERBLOCK
            ...
            $(".hoverblock").hover(function () {
                ...
                TweenMax.fromTo($(this).children(".hoverfuncblack"), 1.4, {x: '-150%', autoAlpha: 1}, {
                    x: '100%',
...
//HOVER MENU FUNC
            ...
            $(".global-menu__item").hover(function () {
                ...
                TweenMax.fromTo($(this).children(".decorationtext").children(".linebltext"), 0.8, {
                    x: '-100%',
                    autoAlpha: 1
                }, {x: '0%', ease: Power3.easeInOut});
                TweenMax.fromTo($(this).children(".deco-desc").children(".linebltext-desc"), 0.8, {x: '0%'}, {
                    x: '-105%',
                    ease: Power3.easeInOut
                });
                TweenMax.fromTo($(this).children(".deco-desc"), 0.8, {autoAlpha: 0}, {
                    autoAlpha: 1,
                    ease: Power3.easeInOut
                });

            }, function () {
                TweenMax.to($(this).children(".decorationtext").children(".linebltext"), 0.8, {
                    x: '105%',
                    ease: Power3.easeInOut
                });
                TweenMax.fromTo($(this).children(".deco-desc").children(".linebltext-desc"), 0.8, {x: '100%'}, {
                    x: '0%',
                    ease: Power3.easeInOut
                });
                TweenMax.fromTo($(this).children(".deco-desc"), 0.8, {autoAlpha: 1}, {
                    autoAlpha: 0,
                    ease: Power3.easeInOut
                });

            });
            $(".global-menu__wrap ul li").hover(function () {

                this.style.setProperty('--tran', 'translate(0,0)');
                this.style.setProperty('--tran1', 'translate(0,0)');
                this.style.setProperty('--op1', '1');
                this.style.setProperty('--op', '1');
...
// SCROLLMAGIC
            ...
            $('.activateblock').each(function () {
                ...
                var OurScene = new ScrollMagic.Scene({
                    ...
                    .setTween(TweenMax.fromTo(this, 0.7, {y: '40px', autoAlpha: 0}, {
                        y: 0,
                        autoAlpha: 1,
...
//HOVER Project
        ...
        $(".projectitem").hover(function () {
            ...
            TweenMax.fromTo($(this).children().children('.titletext').children('.textlinePr'), 0.5, {
                x: '-100%',
                autoAlpha: 1
...
// });
        ...
        tle.staggerFromTo('.item-clients', 1, {y: '80px', autoAlpha: 0}, {
            y: 0,
            autoAlpha: 1,
            ease: Back.easeNone
        }, 0.12);
...
// SCROLLMAGIC
                ...
                pojavSingProjMain
                    .fromTo($('.head-imageblock'), 0.7, {y: '20px', autoAlpha: 0}, {
                        y: 0,
                        autoAlpha: 1,
                        ease: Power2.easeNone
                    })
                    .fromTo($('.logoss-white-top'), 0.7, {y: '20px', autoAlpha: 0}, {
                        y: 0,
                        autoAlpha: 1,
                        ease: Power2.easeNone
                    }, '=-0.5')
                    .fromTo($('.nameproject'), 0.7, {y: '20px', autoAlpha: 0}, {
                        y: 0,
                        autoAlpha: 1,
                        ease: Power2.easeNone
                    }, '=-0.5')
                    .fromTo($('.category-name'), 0.7, {y: '20px', autoAlpha: 0}, {
                        y: 0,
                        autoAlpha: 1,
                        ease: Power2.easeNone
                    }, '=-0.5')
                    .staggerFromTo($('.projecth2'), 0.7, {y: '50px', autoAlpha: 0}, {
                        y: 0,
                        autoAlpha: 1,
                        ease: Power2.easeNone
                    }, 0.2, '=-0.7')
                    .staggerFromTo($('.text-about'), 0.7, {y: '20px', autoAlpha: 0}, {
                        y: 0,
                        autoAlpha: 1,
                        ease: Power2.easeNone
                    }, 0.2, '=-0.5')
                    .staggerFromTo($('.about-item'), 0.7, {y: '20px', autoAlpha: 0}, {
                        y: 0,
                        autoAlpha: 1,
                        ease: Power2.easeNone
                    }, 0.2, '=-0.5')
                    .staggerFromTo($('.galleryprojects>a>.pr_photo'), 0.7, {y: '20px', autoAlpha: 0}, {
                        y: 0,
                        autoAlpha: 1,
                        ease: Power2.easeNone
                    }, 0.2, '=-1')
                    .fromTo($('.get-response'), 0.7, {y: '20px', autoAlpha: 0}, {
                        y: 0,
                        autoAlpha: 1,
                        ease: Power2.easeNone
                    }, '=-0.5')
                    .staggerFromTo($('.category-project-item'), 0.7, {y: '20px', autoAlpha: 0}, {
                        y: 0,
                        autoAlpha: 1,
                        ease: Power2.easeNone
                    }, 0.2, '=-0.5');
...
// "retina_detect":true});
                ...
                topabout
                    ...
                    .staggerFromTo($('.about-link-anchor>.blacktemp'), 0.8, {x: '0%'}, {
                        x: '100%',
                        ease: Power2.easeOut
                    }, 0.2, '=-0.6')
                    .fromTo($('.abs-about-background>.blacktemp'), 1, {x: '0%'}, {
                        x: '100%',
                        ease: Power2.easeInOut
                    }, '=-1.2')
...
//TOP ABOUT PARALLAX BLOCK
                ...
                pojav.staggerFromTo('.history-item.abtstyle', 1, {y: '80px', autoAlpha: 0}, {
                    y: 0,
                    autoAlpha: 0.8,
                    ease: Power2.easeNone
                }, 0.12);
                ...
                pojavhuman.staggerFromTo($('.human'), 1, {y: '60px', autoAlpha: 0}, {
                    y: 0,
                    autoAlpha: 0.8,
                    ease: Power2.easeNone
                }, 0.18)
...
// console.log(SameBl);
                        ...
                        TweenMax.fromTo(SameBlTextLine, 0.7, {x: '-100%', autoAlpha: 1}, {
                            x: '0%',
                            autoAlpha: 1,
                            ease: Power3.easeInOut
                        });
                        TweenMax.to(SameBlHuman, 0.7, {scale: 2, y: -120, autoAlpha: 1, ease: Power3.easeOut});
                        TweenMax.to($(this).next('.human'), 0.7, {
                            scale: 1.2,
                            y: -30,
                            autoAlpha: 0.8,
                            ease: Power3.easeOut
                        });
                        TweenMax.to($(this).prev('.human'), 0.7, {
                            scale: 1.2,
                            y: -30,
                            autoAlpha: 0.8,
                            ease: Power3.easeOut
                ...
                pojavWhatWeDo.fromTo($('.whth2'), 0.7, {y: '30px', autoAlpha: 0}, {
                    y: 0,
                    autoAlpha: 0.8,
                    ease: Power2.easeNone
                })
                    .staggerFromTo($('.itemclass-wthl'), 1, {y: '30px', autoAlpha: 0}, {
                        y: 0,
                        autoAlpha: 0.8,
                        ease: Power2.easeNone
                    }, 0.2, '=-0.4');
                ...
                tle2.staggerFromTo('.item-clients', 1, {y: '80px', autoAlpha: 0}, {
                    y: 0,
                    autoAlpha: 1,
                    ease: Power2.easeNone
                }, 0.12);
...
// SCROLLMAGIC
                ...
                pojavhprojectMain
                    .fromTo($('.logoss-black-top'), 0.7, {y: '20px', autoAlpha: 0}, {
                        y: 0,
                        autoAlpha: 1,
                        ease: Power2.easeNone
                    })
                    .fromTo($('h1.text-project.noafter'), 0.7, {y: '20px', autoAlpha: 0}, {
                        y: 0,
                        autoAlpha: 1,
                        ease: Power2.easeNone
                    }, '=-0.5')
                    .staggerFromTo($('.class-item-category'), 0.7, {y: '20px', autoAlpha: 0}, {
                        y: 0,
                        autoAlpha: 1,
                        ease: Power2.easeNone
                    }, 0.2, '=-0.5')
                    .fromTo($('.rightselect-btn'), 0.7, {y: '20px', autoAlpha: 0}, {
                        y: 0,
                        autoAlpha: 1,
                        ease: Power2.easeNone
                    }, '=-0.5')
                    .staggerFromTo($('.firstblock>.projectitem:nth-child(1)'), 0.7, {y: '50px', autoAlpha: 0}, {
                        y: 0,
                        autoAlpha: 1,
                        ease: Power2.easeNone
                    }, 0.2, '=-0.7');
                ...
                pojavText
                    .fromTo($('.h2block-text'), 0.7, {y: '20px', autoAlpha: 0}, {
                        y: 0,
                        autoAlpha: 1,
                        ease: Power2.easeNone
                    })
                    .staggerFromTo($('.column-ttx>p'), 0.7, {y: '20px', autoAlpha: 0}, {
                        y: 0,
                        autoAlpha: 1,
                        ease: Power2.easeNone
                    }, 0.2, '=-0.4');
...
//SERVICES POJAVLENIE
                ...
                pojavServ
                    .staggerFromTo($('.items-services'), 1, {y: '40px', autoAlpha: 0}, {
                        y: 0,
                        autoAlpha: 1,
                        ease: Power1.easeNone
                    }, 0.3)
                    .staggerFromTo($('.textblock-serv'), 1, {y: '20px', autoAlpha: 0}, {
                        y: 0,
                        autoAlpha: 1,
                        ease: Power1.easeNone
                    }, 0.3, '=-1')
                    .staggerFromTo($('.number-items'), 1, {y: '20px', autoAlpha: 0}, {
                        y: 0,
                        autoAlpha: 1,
                        ease: Power1.easeNone
                    }, 0.3, '=-1.2');
...
// SCROLLMAGIC
                ...
                pojavServtMain
                    ...
                    .staggerFromTo($('.title-srv'), 0.7, {y: '20px', autoAlpha: 0}, {
                        y: 0,
                        autoAlpha: 1,
                        ease: Power2.easeNone
                    }, 0.2, '=-0.8')
                    .staggerFromTo($('.desc-srv'), 0.7, {y: '50px', autoAlpha: 0}, {
                        y: 0,
                        autoAlpha: 1,
                        ease: Power2.easeNone
                    }, 0.2, '=-0.9')
                    .staggerFromTo($('.image-srv'), 0.7, {y: '50px', autoAlpha: 0}, {
                        y: 0,
                        autoAlpha: 1,
                        ease: Power2.easeNone
                    }, 0.2, '=-0.9')
                    .staggerFromTo($('.desctwo-srv'), 0.7, {y: '50px', autoAlpha: 0}, {
                        y: 0,
                        autoAlpha: 1,
                        ease: Power2.easeNone
                    }, 0.2, '=-0.9')
                    .staggerFromTo($('.btnlink-srv'), 0.7, {y: '50px', autoAlpha: 0}, {
                        y: 0,
                        autoAlpha: 1,
                        ease: Power2.easeNone
                    }, 0.2, '=-0.9');
...
// SCROLLMAGIC
                ...
                pojavContacts
                    .fromTo($('.text-project'), 0.7, {y: '40px', autoAlpha: 0}, {
                        y: 0,
                        autoAlpha: 1,
                        ease: Power2.easeNone
                    }, "0.5")
                    .staggerFromTo($('.toptext-form'), 0.7, {y: '50px', autoAlpha: 0}, {
                        y: 0,
                        autoAlpha: 1,
                        ease: Power2.easeNone
                    }, 0.2, '=-0.3')
                    .staggerFromTo($('input'), 0.7, {y: '20px', autoAlpha: 0}, {
                        y: 0,
                        autoAlpha: 1,
                        ease: Power2.easeNone
                    }, 0.2, '=-1')
                    .fromTo($('textarea'), 0.7, {y: '20px', autoAlpha: 0}, {
                        y: 0,
                        autoAlpha: 1,
                        ease: Power2.easeNone
                    }, '=-0.6')
                    .fromTo($('.logoss-contact'), 0.7, {y: '20px', autoAlpha: 0}, {
                        y: 0,
                        autoAlpha: 1,
                        ease: Power2.easeNone
                    }, '=-0.6')
                    .fromTo($('.adress-contact'), 0.7, {y: '20px', autoAlpha: 0}, {
                        y: 0,
                        autoAlpha: 1,
                        ease: Power2.easeNone
                    }, '=-0.6');
